...
from mascan.agents.social_media.prompts import build_user_prompt, render_tool_outputs
from mascan.contracts.reports import AgentReport, Source
from mascan.contracts.tools import ToolResult
from mascan.core.llm import get_chat_model

ALWAYS_CALL_TOOLS: tuple[str, ...] = ("reddit_search",)
OPTIONAL_TOOLS: tuple[str, ...] = ("x_search", "web_search")
