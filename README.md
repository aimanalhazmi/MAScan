...
```
cd existing_repo
git remote add origin https://git.tu-berlin.de/aaip26_group2/mascan.git
git branch -M main
...
* [Set up project integrations](https://git.tu-berlin.de/aaip26_group2/mascan/-/settings/integrations)
